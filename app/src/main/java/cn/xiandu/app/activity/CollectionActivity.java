...
import cn.xiandu.app.db.HomeBeanHelper;
...
public class CollectionActivity extends BaseActivity implements SwipeRefreshLayout.OnRefreshListener {
    ...
    private HomeBeanHelper homeBeanHelper;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        weakHandler.postDelayed(new Runnable() {
            @Override
            public void run() {
                homeBeanHelper = DbUtil.getHomeBeanHelperHelper();
                List<HomeBean> ls = homeBeanHelper.queryAll();
