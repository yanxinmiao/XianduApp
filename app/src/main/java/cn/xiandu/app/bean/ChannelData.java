...
public class ChannelData implements Parcelable {
    ...
    @Generated(hash = 1418153793)
    public ChannelData(String uniquekey, String title, String date, String category, String author_name, String url, String thumbnail_pic_s,
    ...
    public static final Creator<ChannelData> CREATOR = new Creator<ChannelData>() {
        @Override
