...
public class NewsFragment extends BaseFragment {
    ...
    private List<ChannelBean> ls = new ArrayList<>();
...
//            } else {
//            }
//            Type t = new TypeToken<List<ChannelBean>>() {}.getType();
//            ls = gson.fromJson(channel, t);

            ls.add(new ChannelBean("top","头条"));
            ls.add(new ChannelBean("guonei","国内"));
            ls.add(new ChannelBean("guoji","国际"));
            ls.add(new ChannelBean("tiyu","体育"));
            ls.add(new ChannelBean("junshi","军事"));
            ls.add(new ChannelBean("yule","娱乐"));
            ls.add(new ChannelBean("keji","科技"));
            ls.add(new ChannelBean("shehui","社会"));
            for (int i = 0; i < ls.size(); i++) {
                ...
                titleList.add(ls.get(i).getName());
            }
