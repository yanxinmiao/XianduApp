...
//                    }
                    ...
                    intent.putExtra("url", list.get(i).getThumbnail_pic_s());
                    intent.putExtra("id", CommonTool.getMD5Str(list.get(i).getThumbnail_pic_s()));
                    startActivity(intent);
                }
    ...
    private void getData() {
        ...
        OkHttpUtils
                ...
                .addParams("key", Constant.NEWS_API_KEY)
                .addParams("type", channel)
                .build()
                .execute(new StringCallback() {
                    ...
                    public void onResponse(String response, int id) {
                        ...
                        try {
                            ...
                            int code = jsonObject.optJSONObject("result").optInt("stat");
                            if (code == 1) {
                                ...
                                Type t = new TypeToken<List<ChannelData>>() {}.getType();
                                ...
                                if (pageCode == 1) {
                                    ...
                                    ToastUtils.showMyToast(jsonObject.optString("reason"));
                                }
                            }
