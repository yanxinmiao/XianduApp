...
public class WxHotFragment extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    SimpleClickListener simpleClickListener = new SimpleClickListener() {
        ...
        public void onItemChildClick(BaseQuickAdapter baseQuickAdapter, View view, int i) {
            ...
            intent.putExtra("title", list.get(i).getSource());
            startActivity(intent);
        }
    ...
    private void getData() {
        ...
        OkHttpUtils
                ...
                .addParams("key", Constant.WX_APPKEY)
                .addParams("ps", 20 + "")
                .addParams("pno", pageCode + "")
                .build()
                    ...
                    public void onResponse(String response, int id) {
                        ...
                        try {
                            ...
                            if (code == 0) {
                                ...
                                JSONArray ja = jsonObject.optJSONObject("result").optJSONArray("list");
                                if (ja.length() < MAX_SIZE) {
                                    mAdapter.loadComplete();
                                }
                                Type t = new TypeToken<List<HomeBean>>() {
                                }.getType();
                                List<HomeBean> ls = gson.fromJson(ja.toString(), t);
                                mAdapter.addData(ls);
                                pageCode++;
                            } else {
                                loadingLayout.setStatus(LoadingLayout.Error);
                                loadingLayout.setErrorText(jsonObject.optString("errMsg"));
                            }
