...
*/
public class ChannelDataDao extends AbstractDao<ChannelData, String> {
    ...
    @Override
    protected final String updateKeyAfterInsert(ChannelData entity, long rowId) {
        return entity.getUniquekey();
    }
    
    @Override
    public String getKey(ChannelData entity) {
        if(entity != null) {
            return entity.getUniquekey();
        } else {
            return null;
